...
class ExchangeApiResponseDataTest {
        ...
        @Test
        fun `test deserialization of ExchangeResponse`() {
                val jsonResponse = """
        {
            "header": {
        ...
        """.trimIndent()
                ...
                val response = gson.fromJson(jsonResponse, ExchangeResponse::class.java)
                ...
                assertNotNull(seriesData) // Ensure series data is not null
                ...
                val timeDimension = response.structure.dimensions.observation.firstOrNull()
