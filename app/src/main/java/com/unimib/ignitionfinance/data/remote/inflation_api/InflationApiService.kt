...
// codice test api inflazione non funzionante
...
fun main() {
    ...
    val seriesKey = "M.EA.ICP000000.INX"  // Example Series Key for monthly inflation in the Euro Area
    val startPeriod = "2023-01"  // Define the start of the period (e.g., January 2023)
    val endPeriod = "2023-12"  // Define the end of the period (e.g., December 2023)
